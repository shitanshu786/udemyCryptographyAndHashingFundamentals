...
public class CrackCaesar {
	...
	public void crackCaesar(String cipherText) {
		...
		// make a guess about the Caeser cipher's key
		...
		// the most common letter is the whitespace: thats why we 
		// do not care about ' ' in this case
		int approximatedKey = Constants.ALPHABET.indexOf(mostFrequentChar)-
				Constants.ALPHABET.indexOf(' ');
